	...
	<!--Navigation Bar-->
		...
		<?php 
			...
			while ($r = mysqli_fetch_array($row)){
				...
				echo "<h1><a href='7_enrolledCourses.php'>Enrolled Course</a> -> Wanna to DELETE some Purchased COURSE? <a href='21_deletePurchasedCourse.php' class='text-danger'>Click Here</a></h1>";
